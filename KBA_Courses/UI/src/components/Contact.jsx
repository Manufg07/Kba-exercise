        ...
        <div class="container">
          ...
          <div class="contact-cards">
            <div class="contact-card">
              ...
              <p class="contact-info">hello@merakiui.com</p>
            </div>
            ...
            <div class="contact-card">
              ...
              <h2 class="contact-title">Office</h2>
              <p class="contact-description">
            ...
            <div class="contact-card">
              ...
              <p class="contact-description">Mon-Fri from 8am to 5pm.</p>
              <p class="contact-info">+1 (555) 000-0000</p>
            </div>
          </div>
        </div>
      </section>
